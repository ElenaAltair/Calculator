...
public class Calculator {
    ...
    В нем создайте статическую переменную типа Supplier.
    ...
    для математических операций над двумя числами.
    ...
    для произведения математических операций над одним числом
     */
